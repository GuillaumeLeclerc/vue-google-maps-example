...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Users/Rodrigo/Dropbox/Sites/repositories/vue-google-maps-example/src/app.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js?sourceMap!./../node_modules/vue-loader/lib/style-rewriter.js?id=_v-8ada3550&file=app.vue!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./app.vue", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js?sourceMap!./../node_modules/vue-loader/lib/style-rewriter.js?id=_v-8ada3550&file=app.vue!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./app.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vueGoogleMaps = __webpack_require__(9);
	
	(0, _vueGoogleMaps.load)('AIzaSyBzlLYISGjL_ovJwAehh6ydhB56fCCpPQw', '3.23', ['places']); // /* vim: set softtabstop=2 shiftwidth=2 expandtab : */
	// <template>
	// <div>
	//   <h1>Map information</h1>
	//   Map center latitude: <input type="number" v-model="center.lat" number>
	...
	exports.default = {
	  ...
	  filters: {
	    markerRemover: function markerRemover(markers) {
	      if (this.markersEven) {
	        var result = [];
	        for (var i = 0; i < markers.length; i += 2) {
	          result.push(markers[i]);
	  ...
	  components: {
	    ...
	    Marker: _vueGoogleMaps.Marker,
	    Cluster: _vueGoogleMaps.Cluster,
	    InfoWindow: _vueGoogleMaps.InfoWindow,
	    Polygon: _vueGoogleMaps.Polygon,
	    Polyline: _vueGoogleMaps.Polyline,
	    Rectangle: _vueGoogleMaps.Rectangle,
	    Circle: _vueGoogleMaps.Circle,
	    PlaceInput: _vueGoogleMaps.PlaceInput
	  }
	};
	// </script>
	//
